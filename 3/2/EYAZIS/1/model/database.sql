...
CREATE INDEX idx_lexeme_word ON lexemes(word);
CREATE INDEX idx_collocation_head ON collocations(head_lexeme_id);
CREATE INDEX idx_collocation_collocate ON collocations(collocate_lexeme_id);
